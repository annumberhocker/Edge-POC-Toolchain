...
describe('GetBalanceComponent', () => {
  ...
  let mockGetBalanceService;
  let mockDataService

  beforeEach(async(() => {

    mockGetBalanceService = sinon.createStubInstance(GetBalanceService);
    mockGetBalanceService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: GetBalanceService, useValue: mockGetBalanceService },
